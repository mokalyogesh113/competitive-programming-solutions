...
void solve()
{
    ...
    vector<ll> cnta(n,0) , cntb(n,0),cntab(n,0), cntba(n,0), cntaba(n,0);
    ...
    for(auto i:cnta) cout<<i<<" "; cout<<endl;
    // for(auto i:cntb) cout<<i<<" "; cout<<endl;
    for(auto i:cntab) cout<<i<<" "; cout<<endl;
    // for(auto i:cntba) cout<<i<<" "; cout<<endl;
    for(auto i:cntaba) cout<<i<<" "; cout<<endl;
